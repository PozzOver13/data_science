...
var_coach_score = c("delta_nrm_c_wins", "delta_nrm_c_top_wins",
                    "delta_nrm_c_season", "delta_nrm_c_champ_wins")
# creating all combination of predictors
regMat <- expand.grid(c(TRUE,FALSE), c(TRUE,FALSE),
                      c(TRUE,FALSE), c(TRUE,FALSE))
names(regMat) <- c("delta_nrm_c_wins", "delta_nrm_c_top_wins",
                   "delta_nrm_c_season", "delta_nrm_c_champ_wins")
...
save(coach_score_model_final, 
     file = "progR/02R_logistic_model_coach_score.rdata")
save(team_score_model_final, 
     file = "progR/02R_logistic_model_team_score.rdata")
save(mad_score_model_final, 
     file = "progR/02R_logistic_model_marchmadness_score.rdata")

save(training_score, 
     file = "datasets/02R_training_dataset_2008_2013.rdata")
